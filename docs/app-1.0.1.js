! function(t) {
    ...
    function o(t, e, n, i) {
        ...
        var d, h, v = 0,
            m = "" === e ? l : e + f;
        if (Array.isArray(t))
            for (var y = 0; y < t.length; y++) d = t[y], h = m + r(d, y), v += o(d, h, n, i);
        else {
            var g = s(t);
            if (g) {
                var _, b = g.call(t);
                if (g !== t.entries)
                    for (var w = 0; !(_ = b.next()).done;) d = _.value, h = m + r(d, w++), v += o(d, h, n, i);
                else
                    for (; !(_ = b.next()).done;) {
                        var E = _.value;
    ...
    function u(t) {
        ...
        for (var n = 0; n < e; n++) {
            ...
            if (v.performUpdateIfNecessary(r, t.reconcileTransaction, _), i && console.timeEnd(i), o)
    ...
    function r(t, e) {
        var n = {};
        return n[t.toLowerCase()] = e.toLowerCase(), n["Webkit" + t] = "webkit" + e, n["Moz" + t] = "moz" + e, n["ms" + t] = "MS" + e, n["O" + t] = "o" + e.toLowerCase(),
            n
    }
            ...
            var n = "Connect(" + u(t) + ")",
                r = function(r) {
                    function u(t, e) {
                        ...
                        a.version = M, a.store = t.store || e.store, (0, C.default)(a.store, 'Could not find "store" in either the context or ' + ('props of "' + n + '". ') + "Either wrap the root component in a <Provider>, " + ('or explicitly pass "store" as a prop to "' + n + '".'));
                    ...
                    return a(u, r), u.prototype.shouldComponentUpdate = function() {
                        ...
                        return !(this.mergedProps && k && (0, v.default)(t, this.mergedProps)) && (this.mergedProps = t, !0)
    ...
    e.default = function(t, e, n) {
        ...
        var o = (0, u.default)(n);
        if (!i.default.Iterable.isIterable(t)) return "The " + o + ' is of unexpected type. Expected argument to be an instance of Immutable.Iterable with the following properties: "' + r.join('", "') + '".';
    ...
    document.title = a.default.data.title[E], t.exports = {
        blockShape: u,
        origin: s,
        blockType: c,
        speeds: l,
            ...
            return u(e, t), s(e, [{
                    ...
                    if (B.visibilityChangeEvent && document.addEventListener(B.visibilityChangeEvent, function() {
                        ...
                        if (U.lastRecord.cur && !U.lastRecord.pause) {
                            var t = this.props.speedRun,
                                e = U.speeds[t - 1] / 2;
                            e = t < U.speeds[U.speeds.length - 1] ? U.speeds[U.speeds.length - 1] : t, z.default.auto(e)
                        }
                ...
                value: function() {
                    ...
                    return l.default.createElement("div", {
                        ...
                        className: (0, d.default)((t = {}, o(t, y.default.rect, !0), o(t, y.default.drop, this.props.drop), t))
    ...
    ! function() {
        ...
        "undefined" != typeof t && t.exports ? (n.default = n, t.exports = n) : (r = [], o = function() {
            return n
    ...
    var u = function() {
        ...
        C = function(t) {
            ...
            return a(e, t), u(e, [{
                ...
                value: function(t) {
                    ...
                    for (var r = function(t) {
                            if (t <= 19) n = n.set(19 - t, (0, l.List)(_.fillLine));
                                ...
                                if (!(t >= 20 && t <= 39)) return void w.default.overEnd();
                ...
                value: function() {
                    var t = void 0;
                    return t = this.state.isOver ? this.state.overState : this.getResult(), c.default.createElement("div", {
    ...
    var o = n(207),
        ...
        d = {
            ...
            start: function() {
                ...
                d.dispatchPoints(0), a.default.dispatch(c.default.speedRun(t.get("speedStart")));
            ...
            auto: function(t) {
                var e = t < 0 ? 0 : t,
                    ...
                    o = function t() {
                        ...
                        var e = r.fall();
                        if ((0, u.want)(e, n.get("matrix"))) a.default.dispatch(c.default.moveBlock(e)), d.fallInterval = setTimeout(t, l.speeds[n.get("speedRun") - 1]);
                        else {
                            var o = n.get("matrix"),
                                i = r && r.shape,
                                s = r && r.xy;
            ...
            nextAround: function(t, e) {
                clearTimeout(d.fallInterval), a.default.dispatch(c.default.lock(!0)), a.default.dispatch(c.default.matrix(t)), "function" == typeof e && e();
                var n = a.default.getState().get("points") + 10 + 2 * (a.default.getState().get("speedRun") - 1);
                return d.dispatchPoints(n), (0, u.isClear)(t) ? void(f.music.clear && f.music.clear()) : (0, u.isOver)(t) ? (f.music.gameover && f.music.gameover(), void d.overStart()) : void setTimeout(function() {
            ...
            focus: function(t) {
                if (a.default.dispatch(c.default.focus(t)), !t) return void clearTimeout(d.fallInterval);
                var e = a.default.getState();
                !e.get("cur") || e.get("reset") || e.get("pause") || d.auto()
            },
            pause: function(t) {
                return a.default.dispatch(c.default.pause(t)), t ? void clearTimeout(d.fallInterval) : void d.auto()
            },
            ...
            dispatchPoints: function(t) {
                a.default.dispatch(c.default.points(t)), t > 0 && t > a.default.getState().get("max") && a.default.dispatch(c.default.max(t))
            }
        };
    e.default = d
}, function(t, e, n) {
        ...
        y = function(t) {
            ...
            return u(e, t), s(e, [{
                ...
                value: function() {
                    var t;
                    return l.default.createElement("div", {
                        className: (0, p.default)((t = {
                            bg: !0
                        }, o(t, m.default.music, !0), o(t, m.default.c, !this.props.data), t))
                    })
                }
            }]), e
        }(l.default.Component);
            ...
            return u(e, t), s(e, [{
                ...
                value: function() {
                    ...
                    return l.default.createElement("div", {
                        className: (0, p.default)((t = {
                            bg: !0
                        }, o(t, m.default.pause, !0), o(t, m.default.c, this.state.showPause), t))
                    })
                }
            }]), e
        }(l.default.Component);
    e.default = y, y.statics = {
        timeout: null
    }, y.propTypes = {
        data: h.default.bool.isRequired
    }, y.defaultProps = {
            ...
            return u(e, t), s(e, [{
                ...
                value: function() {
                    ...
                    return this.props.cur ? null : l.default.createElement("div", {
                        ...
                        className: (0, p.default)((t = {
                            bg: !0
                        }, o(t, m.default.dragon, !0), o(t, this.state.style, !0), t))
                ...
                value: function() {
                    ...
                    document.addEventListener("touchstart", function(t) {
                        ...
                        t["dom_" + r].dom.addEventListener("mousedown", function() {
                            e[r] !== !0 && (w.default[r].down(_.default), n[r] = !0)
                        }, !0), t["dom_" + r].dom.addEventListener("mouseup", function() {
                            return e[r] === !0 ? void(e[r] = !1) : (w.default[r].up(_.default), void(n[r] = !1))
            ...
            return u(e, t), s(e, [{
                ...
                value: function() {
                    var t, e = this,
                        ...
                        d = n.arrow;
                    return l.default.createElement("div", {
                        className: (0, p.default)((t = {}, o(t, m.default.button, !0), o(t, m.default[i], !0), o(t, m.default[a], !0), t)),
                        style: {
                            top: u,
                            left: s
                        }
    ...
    var o = n(220),
        ...
        p = n(217),
        d = function(t) {
            t.dispatch(s.default.keyboard.left(!0)), a.default.down({
                key: "left",
                begin: 200,
                interval: 100,
                callback: function() {
                    ...
                    if (!e.get("lock")) {
                        ...
                        if (null !== n) {
                            ...
                            var r = n.left(),
                                ...
                                a = void 0;
                            (0, o.want)(r, e.get("matrix")) ? (r.timeStamp += parseInt(i, 10), t.dispatch(s.default.moveBlock(r)), a = r.timeStamp) : (n.timeStamp += parseInt(parseInt(i, 10) / 1.5, 10), t.dispatch(s.default.moveBlock(n)), a = n.timeStamp);
                            var u = f.speeds[e.get("speedRun") - 1] - (Date.now() - a);
                            l.default.auto(u)
                        } else {
                            var c = e.get("speedStart");
                            c = c - 1 < 1 ? 6 : c - 1, t.dispatch(s.default.speedStart(c))
                        }
                    }
                }
            })
        ...
        h = function(t) {
            t.dispatch(s.default.keyboard.left(!1)), a.default.up({
                key: "left"
            })
        };
    e.default = {
    ...
    var o = n(220),
        ...
        p = n(217),
        d = function(t) {
            t.dispatch(s.default.keyboard.right(!0)), a.default.down({
                key: "right",
                begin: 200,
                interval: 100,
                callback: function() {
                    ...
                    if (!e.get("lock")) {
                        ...
                        if (null !== n) {
                            ...
                            var c = e.get("speedStart");
                            c = c + 1 > 6 ? 1 : c + 1, t.dispatch(s.default.speedStart(c))
                        }
                    }
                }
            })
        ...
        h = function(t) {
            t.dispatch(s.default.keyboard.right(!1)), a.default.up({
                key: "right"
            })
        };
    e.default = {
    ...
    var o = n(220),
        ...
        f = n(217),
        p = function(t) {
            t.dispatch(s.default.keyboard.down(!0)), null !== t.getState().get("cur") ? a.default.down({
                key: "down",
                begin: 40,
                interval: 40,
                callback: function(e) {
                    ...
                    if (!n.get("lock")) {
                        ...
                        if (null !== r) {
                            ...
                            var i = r.fall();
                            if ((0, o.want)(i, n.get("matrix"))) t.dispatch(s.default.moveBlock(i)), l.default.auto();
                            else {
                                var a = n.get("matrix"),
                                    u = r.shape,
                                    c = r.xy;
                ...
                callback: function() {
                    if (!t.getState().get("lock")) {
                        ...
                        if (!n) {
                            ...
                            r = r - 1 < 0 ? 10 : r - 1, t.dispatch(s.default.startLines(r))
                        }
                    }
                }
            })
        ...
        d = function(t) {
            t.dispatch(s.default.keyboard.down(!1)), a.default.up({
                key: "down"
            })
        };
    e.default = {
    ...
    var o = n(220),
        ...
        f = n(217),
        p = function(t) {
            t.dispatch(s.default.keyboard.rotate(!0)), null !== t.getState().get("cur") ? a.default.down({
                key: "rotate",
                once: !0,
                callback: function() {
                    var e = t.getState();
                    if (!e.get("lock")) {
                        ...
                        if (null !== n) {
                            ...
                            var r = n.rotate();
                            (0, o.want)(r, e.get("matrix")) && t.dispatch(s.default.moveBlock(r))
                        }
                    }
                }
            }) : a.default.down({
                ...
                callback: function() {
                    if (!t.getState().get("lock")) {
                        ...
                        if (!n) {
                            var r = e.get("startLines");
                            r = r + 1 > 10 ? 0 : r + 1, t.dispatch(s.default.startLines(r))
                        }
                    }
                }
            })
        ...
        d = function(t) {
            t.dispatch(s.default.keyboard.rotate(!1)), a.default.up({
                key: "rotate"
            })
        };
    e.default = {
    ...
    var o = n(220),
        ...
        f = n(217),
        p = function(t) {
            t.dispatch(s.default.keyboard.drop(!0)), a.default.down({
                key: "space",
                once: !0,
                callback: function() {
                    var e = t.getState();
                    if (!e.get("lock")) {
                        ...
                        if (null !== n) {
                            ...
                            }), t.dispatch(s.default.drop(!0)), setTimeout(function() {
        ...
        d = function(t) {
            t.dispatch(s.default.keyboard.drop(!1)), a.default.up({
                key: "space"
            })
        };
    e.default = {
    ...
    var o = n(269),
        ...
        u = r(a),
        s = function(t) {
            t.dispatch(u.default.keyboard.music(!0)), t.getState().get("lock") || i.default.down({
                key: "s",
                once: !0,
                callback: function() {
        ...
        c = function(t) {
            t.dispatch(u.default.keyboard.music(!1)), i.default.up({
                key: "s"
            })
        };
    e.default = {
    ...
    var o = n(269),
        ...
        c = r(s),
        l = function(t) {
            t.dispatch(c.default.keyboard.reset(!0)), t.getState().get("lock") || (null !== t.getState().get("cur") ? i.default.down({
                key: "r",
                once: !0,
                callback: function() {
                    u.default.overStart()
        ...
        f = function(t) {
            t.dispatch(c.default.keyboard.reset(!1)), i.default.up({
                key: "r"
            })
        };
    e.default = {
    ...
    var o = n(269),
        ...
        c = r(s),
        l = function(t) {
            t.dispatch(c.default.keyboard.pause(!0)), i.default.down({
                key: "p",
                once: !0,
                callback: function() {
                    var e = t.getState();
        ...
        f = function(t) {
            t.dispatch(c.default.keyboard.pause(!1)), i.default.up({
                key: "p"
            })
        };
    e.default = {
    ...
    function r(t, e) {
        for (var n = t.size, r = g.getPositions(e), o = 0; o < r.length; o++)
            for (var i = r[o][0], a = r[o][1], u = -1; u <= 7; u++)
                if (!(i + u <= -1 || n <= i + u))
                    for (var s = -1; s <= 7; s++) a + s <= -1 || n <= a + s || (u >= 0 && u <= 6 && (0 === s || 6 === s) || s >= 0 && s <= 6 && (0 === u || 6 === u) || u >= 2 && u <= 4 && s >= 2 && s <= 4 ? t.set(i + u, a + s, !0, !0) : t.set(i + u, a + s, !1, !0))
    }
    ...
    function i(t, e) {
        for (var n = y.getPositions(e), r = 0; r < n.length; r++)
            for (var o = n[r][0], i = n[r][1], a = -2; a <= 2; a++)
                for (var u = -2; u <= 2; u++) a === -2 || 2 === a || u === -2 || 2 === u || 0 === a && 0 === u ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0)
    }
